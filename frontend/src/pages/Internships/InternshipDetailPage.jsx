      ...
      <div className="mx-auto max-w-4xl px-4 pt-24 pb-10 space-y-5 text-xs">
        <header className="space-y-1">
          ...
          <p className="text-slate-400">
            {internship.location || 'Location N/A'} · {internship.mode || 'remote'} · Stipend:{' '}
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
          ...
          <p className="text-[11px] text-slate-200 whitespace-pre-line">{internship.description}</p>
        </section>
        ...
        <section className="space-y-2 rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
          ...
          <p className="text-[11px] text-slate-400">
            You can optionally leave a short note for the recruiter. Your latest resume from the Resume Analyzer will
            be attached automatically (once wired on backend).
          </p>
          <textarea
            value={message}
